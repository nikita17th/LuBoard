...
import com.lutalic.luboard.core.utils.Event
import com.lutalic.luboard.core.views.BaseFragment
import com.lutalic.luboard.core.views.BaseScreen
import com.lutalic.luboard.core.views.BaseScreen.Companion.ARG_SCREEN
import com.lutalic.luboard.core.views.HasScreenTitle
...
class StackFragmentNavigator(
    ...
    private fun launchFragment(screen: BaseScreen, addToBackStack: Boolean = true) {
        // we find the fragment in which this screen lies
